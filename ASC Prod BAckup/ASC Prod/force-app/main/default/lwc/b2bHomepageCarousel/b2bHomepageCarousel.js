...
import getData from "@salesforce/apex/b2bHomepageCarouselController.getData";
        ...
        if (res.isSuccess) {
          if (response.imageDataList) {
            ...
            this.timer = window.setInterval(() => {
              this.slideSelector(this.slideIndex + 1);
            }, this.slideTimer);
          }
        } else {
          //show no data found error
          console.log("getData is success false---- " + JSON.stringify(res));
        }
      })
      .catch((e) => {
        console.log("getData catch---- " + JSON.stringify(e));
      });
  }
