...
export default class SearchResults extends NavigationMixin(LightningElement) {
    ...
    get normalizedSearchResults() {
        console.log('SEARCH RESULTS \n', JSON.parse(JSON.stringify(this.searchResults)));
    ...
    get searchTerm(){
        ...
        // let finalMessage = totalResults == 0 ?
    ...
    countRender = 0;
    renderedCallback(){
        // let METHOD = 'renderedCallback'; 
        this.countRender = this.countRender + 1;
        // console.log(METHOD + ' this.hasResults ' , this.hasResults)
        // console.log(METHOD + ' this._searchTerm ' , this._searchTerm)
        // console.log(METHOD + ' this.countRender ' , this.countRender)

        if (! this.hasResults && this._searchTerm && this.countRender > 1) setTimeout(this.veryExistingResults.bind(this), 200); // 2 seconds
    }

    veryExistingResults(){
        // let METHOD = 'veryExistingResults'; 
